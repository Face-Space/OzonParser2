...
class ControlTab:
    ...
    def create_widgets(self):
        ...
        ttk.Label(status_group, text="Telegram бот:", font=('Arial', 14, 'bold')).grid(row=0, column=0, sticky=tk.W,
                                                                                       pady=5)
        ttk.Label(status_group, textvariable=self.bot_status_var, font=('Arial', 14)).grid(row=0, column=1, sticky=tk.W,
                                                                                           padx=(10, 0), pady=5)
